...
type FilterKey = 'watched' | 'favorites' | 'withNotes';
  ...
  <div className="flex items-center space-x-2">
    <span className="text-sm font-medium text-gray-600">Filters:</span>
      <div className="flex space-x-2">
        <button 
          className={`flex items-center px-3 py-1.5 rounded-md text-sm ${activeFilters.watched ? 'bg-green-100 text-green-800' : 'border border-gray-300'}`}
          onClick={() => toggleFilter('watched')}>
          <Eye className="w-4 h-4 mr-1.5" />
          Watched
        </button>
      <button 
        className={`flex items-center px-3 py-1.5 rounded-md text-sm ${activeFilters.favorites ? 'bg-red-100 text-red-800' : 'border border-gray-300'}`}
        onClick={() => toggleFilter('favorites')}>
        <Heart className="w-4 h-4 mr-1.5" />
        Favorites
      </button>
      <button 
        className={`flex items-center px-3 py-1.5 rounded-md text-sm ${activeFilters.withNotes ? 'bg-blue-100 text-blue-800' : 'border border-gray-300'}`}
      ...
      <div className="relative">
        <button 
          className="flex items-center px-3 py-1.5 rounded-md text-sm border border-gray-300"
          ...
          <div className="p-2">
            ...
            <div className="flex items-center py-1 px-2 hover:bg-gray-100 rounded cursor-pointer">
              ...
              <label htmlFor="any-rating" className="text-sm flex items-center">
                Any Rating <Star className="w-3 h-3 ml-1 text-yellow-500" />
              </label>
            </div>
